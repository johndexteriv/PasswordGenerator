...
function writePassword() {
        ...
        //function that wraps all the prompts --> will be generate password
        ...
        function passwordOptions() {
            ...
            if (useUpperCase === false && useNumbers === false && useSpecial === false){
                return console.log("lower case only");
            } else if (useUpperCase === true && useNumbers === false  && useSpecial === false) {
                return console.log("lower case and upper case only");
            } else if (useUpperCase === true && useNumbers === true && useSpecial === false) {
                return console.log("lower case, upper case and numbers only");
            } else if (useUpperCase === true && useNumbers === false && useSpecial === true) {
                return console.log("lower case, upper case and special only");
            } else if (useUpperCase === false && useNumbers === true && useSpecial === false){
                return console.log("lower case and numbers only");
            } else if (useUpperCase === false && useNumbers === true && useSpecial === true){
                return console.log("lower case, numbers and special only");
            } else if (useUpperCase === false && useNumbers === false && useSpecial === true){
                return console.log("lower case and special only");
            } else {
                return console.log("all charSet");
            }
